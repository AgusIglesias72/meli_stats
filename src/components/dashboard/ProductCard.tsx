...
interface ProductCardProps {
    ...
    status: string;
    last_updated: string;
    seller_nickname?: string; // Añadimos el nombre del vendedor como opcional
    seller_id?: string; // Añadimos el ID del vendedor como opcional
    notes?: string | null;
    brand?: string | null; 
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            {seller_nickname && (
                                <p className="text-xs text-gray-600 mt-1 flex items-center">
                                    <Store className="h-3 w-3 mr-1 inline-block" />
                                    <span className="truncate">{seller_nickname}</span>
                                </p>
                            )}
