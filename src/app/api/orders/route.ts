...
async function getAllPaginatedOrders(
  ...
  for (let page = 1; page <= totalPages; page++) {
    ...
    if (allOrders.length >= 5000) {  // Límite para evitar respuestas demasiado grandes
      console.warn(`Reached limit of 5000 orders, stopping pagination at page ${page} of ${totalPages}`);
      break;
    }
  }
