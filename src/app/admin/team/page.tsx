    ...
    <div className="px-4 lg:px-6">
      ...
      {storeInfo && (
        <p className="text-muted-foreground mb-6">
          Tienda: {storeInfo.name || storeInfo.store_id}
        </p>
      )}
        ...
        <Card className="shadow-sm mb-8">
          <CardContent className="p-0">
            <Tabs defaultValue="members" className="w-full">
              <TabsList className="w-full rounded-t-lg rounded-b-none bg-muted border-b">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Control total sobre la tienda. Puede gestionar miembros, configuraciones y eliminar la tienda.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Puede gestionar productos, precios, invitar a nuevos miembros y cambiar roles, pero no puede eliminar la tienda.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Puede gestionar productos, actualizar precios y ver estadísticas, pero no puede gestionar miembros del equipo.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Solo puede ver productos, precios y estadísticas, sin capacidad de realizar cambios.</p>
              </div>
            </div>
          </div>
        </CardContent>
